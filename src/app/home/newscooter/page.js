...
function page() {
  return (
    <div className="px-6 md:px-12 lg:px-44">
      <h1 className="text-black text-2xl font-extrabold mt-12">Best Scooters</h1>
...
<div>
  <h1 className="text-black text-2xl font-extrabold mt-12">Best Scooters in India 2025</h1>
  <div className="p-4">
