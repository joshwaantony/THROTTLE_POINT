      ...
      >
        {compareData.map((item, index) => (
          <div key={index} className="mt-5">
            <div className="flex-shrink-0 border justify-between bg-white border-gray-300 rounded-2xl w-[250px] sm:w-[400px]">
              <div className="flex">
                <div className="w-[200px] relative text-black border-r border-r-gray-300">
                  <Image
                    src={item.left.image}
                    alt={item.left.model}
                    width={200}
